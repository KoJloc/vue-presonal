              ...
              <div class="big-product single-product-three slider-for">
                <div>
                  <div class="single-item">
                    <img  src="assets/images/home-three/products-1.jpg" alt="">
                    <div class="ptag"> <span class="one">-20% </span> <span class="two">in stock
                                            </span> </div> <a href="#0" class="love"> <i class="flaticon-like"></i> </a>
                    <a href="assets/images/home-three/products-1.jpg" class="zoom">
                      <i class="flaticon-zoom-1"></i> </a>
                  </div>
                </div>
                <div>
                  <div class="single-item"> <img
                      src="assets/images/home-three/products-2.jpg" alt="">
                    <div class="ptag"> <span class="one">-20% </span> <span class="two">in stock
                                            </span> </div> <a href="#0" class="love"> <i class="flaticon-like"></i> </a>
                    <a href="assets/images/home-three/products-2.jpg" class="zoom">
                      <i class="flaticon-zoom-1"></i> </a>
                  </div>
                </div>
                <div>
                  <div class="single-item"> <img
                    ...
                    <a href="assets/images/home-three/products-3.jpg" class="zoom">
                      <i class="flaticon-zoom-1"></i> </a>
                  </div>
                </div>
                <div>
                  <div class="single-item"> <img
                      src="assets/images/home-three/products-4.jpg" alt="">
                    <div class="ptag"> <span class="one">-20% </span> <span class="two">in stock
                                            </span> </div> <a href="#0" class="love"> <i class="flaticon-like"></i> </a>
                    <a href="assets/images/home-three/products-4.jpg" class="zoom">
                      <i class="flaticon-zoom-1"></i> </a>
                  </div>
                </div>
                <div>
                  <div class="single-item"> <img
                    ...
                    <a href="assets/images/home-three/products-5.png" class="zoom">
                      <i class="flaticon-zoom-1"></i> </a>
                  </div>
                </div>
                <div>
                  <div class="single-item"> <img
                    ...
                    <a href="assets/images/home-three/products-6.png"
                       class="zoom"> <i class="flaticon-zoom-1"></i> </a>
                  </div>
                </div>
              </div>
              <div class="product-slicknav single-product-three-nav slider-nav">
                <div> <span class="single-item"> <img
                    src="assets/images/home-three/products-1.jpg" alt="">
                                    </span> </div>
                <div> <span class="single-item"> <img
                    src="assets/images/home-three/products-2.jpg" alt="">
                                    </span> </div>
            ...
            <div class="shop-details-top-right three">
              <div class="shop-details-top-right-content-box">
                ...
                <div
                  ...
                  <div>
                    <h3 class="pe-1"><del class="m-0 me-1">$50.00</del> $30.00 </h3>
                    <p>(+15% Vat Included)</p>
                  </div> <a href="#0" class="pshare"> <i class="flaticon-share-1"></i> </a>
                </div>
                <div class="color-size-box">
                  <div class="shop-details-top-color-sky-box ">
                    ...
                    <ul class="m-0 varients">
                      <li> <a href="#0" class="shop-details-top-color-sky-img"
                        ...
                        <img src="assets/images/home-three/products-6.png"
                             alt=""> </a> </li>
                      <li> <a href="#0" class="shop-details-top-color-sky-img"
                  ...
                  <div class="size-box">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="size-sellect language"> <select>
                        <option>28 </option>
                        <option value="1">32</option>
                        <option value="4">34</option>
                        <option value="4">36</option>
                      </select> </div> <a href="#0" class="ps-2">Size Guide</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="shop-details-top-buy-now-btn"> <a href="cart.html" class="btn--primary">Buy
                  It Now</a> </div>
                ...
                <p class="shop-details-top-product-sale"> 50 visitor are looking at this product! </p>
