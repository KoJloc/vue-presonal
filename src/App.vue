    ...
    <header class="header-style-3">
            ...
            <div class="mobile-menu ">
                ...
                <div class="container">
                  <div class="row">
                    <div class="menu-info d-flex justify-content-between align-items-center">
                      ...
                      <router-link class="logo" to="/"><span>Home название<img src=""> </span></router-link>
              ...
              <div class="mobile-menu__sidebar-menu">
                ...
                <ul class="page-dropdown-menu">
                  ...
                  <li class="dropdown-list"><router-link to="/companies"><span>Компании </span></router-link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="d-lg-block d-none">
            <div class="row g-0 position-relative">
              <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                <div class="logo"><a href="/"> название <img src="" alt=""> </a>
                </div>
              </div>
              <div class="col-lg-9 g-0 p-0">
                <div class="row g-0 holder">
                  <div class="col">
                    <div class="some-info">
                      <div class="right d-flex align-items-right ">
      ...
      <div class="sticy-header">
            ...
            <div class="container">
              <div class="row">
                <div class="menu-info d-flex justify-content-between align-items-center">
                  <div class="menubar"><span></span> <span></span> <span></span></div>
                  <a
                      href="/" class="logo"> название <img src="" alt=""> </a>
                  <div class="cart-holder">
                    <a href="#0" class="cart cart-icon position-relative">
                      <i class="flaticon-shopping-cart"></i>
                    </a>
        ...
        <div class="container position-relative d-lg-block d-none">
          <div class="d-flex align-items-center justify-content-between"><a href="/" class="logo me-2"> название
            <img src="" alt=""> </a>
            <div class="mega-menu-default mega-menu d-lg-block d-none">
              <div class="container ">
                <div class="row">
